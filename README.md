...
Диаграмма отражает схему движения специалиста по координации осмотров в программном средстве. Для удобства восприятия на диаграмме выделено несколько крупных бизнес-процессов, каждый из которых обозначен отдельной областью. 
...
User-flow диаграмма отражает процесс работы инспектора в программном средстве. Для удобства восприятия процесс разделён на несколько крупных бизнес-блоков. Красным цветом выделен блок целевого бизнес-процесса предметной области.
